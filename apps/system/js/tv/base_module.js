/* global LazyLoader, DUMP, TO_BE_MIGRATED */
'use strict';
...
(function(exports) {
   ...
   * @example
   * BaseModule.parsePath('path/to/ModuleName');
  ...
  BaseModule.object2fileName = function(string) {
    ...
    // This line should be removed as soon as we migrate all the tv system
    // files to the System app
    var path = TO_BE_MIGRATED.indexOf(ch + '.js') > -1 ? 'tv/' : '';

    return '/js/' + path + module.path + ch + '.js';
  };
